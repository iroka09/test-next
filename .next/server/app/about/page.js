...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 2604)), "/data/data/com.termux/files/home/test-next/src/app/about/page.tsx"],
    ...
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 1318)), "/data/data/com.termux/files/home/test-next/src/app/layout.tsx"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 2819))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["/data/data/com.termux/files/home/test-next/src/app/about/page.tsx"];
...
/* harmony import */ var _components_redux_userSlice__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6180);
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
    ...
    const ageRef = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)();
    const user = (0,react_redux__WEBPACK_IMPORTED_MODULE_4__/* .useSelector */ .v9)((state)=>state.user);
    ...
    const handleApply = ()=>{
        ...
        dispatch((0,_components_redux_userSlice__WEBPACK_IMPORTED_MODULE_2__/* .changeName */ .eu)(name));
        dispatch((0,_components_redux_userSlice__WEBPACK_IMPORTED_MODULE_2__/* .changeAge */ .yJ)(age));
    };
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/data/data/com.termux/files/home/test-next/src/app/about/page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [318,501,621,700], () => (__webpack_exec__(1412)));
